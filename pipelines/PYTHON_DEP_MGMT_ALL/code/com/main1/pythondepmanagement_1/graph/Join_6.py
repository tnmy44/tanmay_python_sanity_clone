...
def Join_6(spark: SparkSession, in0: DataFrame, in1: DataFrame, ) -> DataFrame:
    return in0\
        .alias("in0")\
        .join(in1.alias("in1"), expr(Config.c_join_expr), "inner")\
        .where(((col("in0.`c- short`") > lit(Config.c_0)) & (col("in1.`c- short`") > lit(Config.c_1))))\
